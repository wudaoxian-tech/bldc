...
void utils_fft32_bin2(float *real_in, float *real, float *imag) {	// Bin2
	*real = 0.0;
	*imag = 0.0;
	for (int i = 0;i < 32;i++) {
...
const float utils_tab_sin_32_2[] = {	// sin(4*pi*n/32)
...
const float utils_tab_cos_32_2[] = {	// cos(4*pi*n/32)
